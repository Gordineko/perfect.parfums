    ...
    return (
        <form onSubmit={formik.handleSubmit} className="auth-form">
            <div className="form-group">
                <label htmlFor="name">{t("authorization.nameLabel")}</label>
                <div className="auth-input-wrap">
                    ...
                    <input
                        ...
                        placeholder={t("authorization.regNamePlaceholder")}
                    />
                </div>
            ...
            */}
            ...
            <div className="form-group">
                ...
                <div className="auth-input-wrap">
                    ...
                    <input
                        ...
                        placeholder={t("authorization.regPasswordPlaceholder")}
                    />
                    <button
                        type="button"
            ...
            <div className="form-checkbox">
                <label className="custom-checkbox-label custom-checkbox-label--top">
                    <input
                        type="checkbox"
                        name="terms"
                        onChange={formik.handleChange}
                    ...
                    <span className="custom-checkbox-text">
                        ...
                        <span className="auth-terms-asterisk">*</span>
                    </span>
                </label>
                {formik.touched.terms && formik.errors.terms ? <div className="error-text-check" style={{ marginTop: '5px' }}>{formik.errors.terms}</div> : null}
            </div>
