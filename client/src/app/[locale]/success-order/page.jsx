  ...
  return (
    <div className={styles.pageShell}>
      <div className="container">
        <section className={styles.shell} aria-labelledby="success-order-title">
          <div className={styles.hero}>
            <div className={styles.icon}>
              <SuccessCheckIcon />
            </div>

            <h1 id="success-order-title" className={styles.title}>
              {t("successOrderPage.titlePrefix")}{" "}
              <span className={styles.titleAccent}>
                {t("successOrderPage.titleAccent")}
              </span>
            </h1>

            <p className={styles.subtitle}>{t("successOrderPage.subtitle")}</p>
          </div>

          <article className={styles.card}>
            <header className={styles.cardHeader}>
              <p className={styles.orderNumber}>
                {t("successOrderPage.orderLabel", { number: orderNumber })}
              </p>
              <p className={styles.orderMeta}>
                {t("successOrderPage.placedAt", { date: placedAt })}
              </p>
            </header>
                ...
                return (
                  <li key={item.id} className={styles.productItem}>
                    ...
                    <span className={styles.productMeta}>
                      {t("successOrderPage.itemQty", { qty: item.quantity })}{" "}
          ...
          <footer className={styles.footer}>
            <div className={styles.support}>
              <p className={styles.supportLabel}>
                {t("successOrderPage.supportLabel")}
              </p>
              <a
                className={styles.supportLink}
                href={`mailto:${t("successOrderPage.supportEmail")}`}
              >
                {t("successOrderPage.supportEmail")}
              </a>
            </div>
